...
| `onChangeName`  | string    |          |             | This prop allow you to target that specific event name, eg: component `onChange` event is named `onTextChange`                                                                           |
| `onChangeEvent` | Function  |          |             | Callback function to return input value. component callback argument may have different signature and allow you to customise the value return.                                           |
| `onBlurName`    | string    |          |             | This prop allow you to target that specific event name, eg: component `onBlur` event is named `onTextBlur`                                                                               |
| `onBlurEvent`   | Function  |          |             | Callback function to return input value. component callback argument may have different signature and allow you to customise the value return.                                           |
